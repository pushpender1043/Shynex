...
function Hero({heroData,heroCount,setHeroCount}) {
  return (
    <div className='w-[40%] h-[100%] flex relative'>
        <div className='absolute text-[#0e4250] text-[20px] md:text-[40px] lg:text-[55px] md:left-[10%] md:top-[90px] lg:top-[130px] left-[10%] top-[10px]'>
            <p>{heroData.text1}</p>
            <p>{heroData.text2}</p>
        </div>
